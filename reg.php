...
$s="select * from reg_record where std_num= '$std_num'";
...
if($num == 1){
   $msg="Sorry Student Number  already Exist! Please try using another student number.";
}else{
   $reg="insert into reg_record values('$std_num', '$name','$pass')";
    mysqli_query($con, $reg);
   $msg= "Resgistration Successful! Now you can use your student number to login. Kindly return to login form";
}
?>
